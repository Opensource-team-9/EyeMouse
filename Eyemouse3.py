...
# Scaling factors to adjust the cursor movement range
scaling_factor_x = 1.5  # Increase this value to expand horizontal movement range
scaling_factor_y = 1.5  # Increase this value to expand vertical movement range
...
# Start button
start_button = tk.Button(root, text="Start Eye Controlled Mouse", command=start_thread)
